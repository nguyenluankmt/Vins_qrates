	...
	<div class="user__configuration_container">
		<div class="user__configuration_wrap">
			<div class="user__configuration_heading">
				<h2 class="user__configuration_title">Login to QRATES</h2>
			</div>
			...
			<div class="user__common__form">
				<form accept-charset="UTF-8" action="https://qrates.com/user/login" class="new_user" id="new_user" method="post">
					...
					<p class="user__new__forgotten">
						<a href="https://qrates.com/user/password/new?modal=false">Forgot your password?</a>
					</p>
					<div class="btn__login">
						<input class="input__click_area" name="commit" type="submit" value="Login">
					</div>
				</form>
			</div>
			<p class="user__new__create">Not a Member?&nbsp;
